...
<div class="bx_filter <?= $templateData["TEMPLATE_CLASS"] ?> catalog-filter" id="catalog-filter">
	<div class="bx_filter_section catalog-filter__inner">
		...
		<div class="bx_filter_title catalog-filter__title"><? echo GetMessage("CT_BCSF_FILTER_TITLE") ?></div>
		<form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>" method="get" class="smartfilter catalog-filter__box">
			...
			foreach ($arResult["ITEMS"] as $key => $arItem) {
				...
				if (isset($arItem["PRICE"])) :
					if ($arItem["VALUES"]["MAX"]["VALUE"] - $arItem["VALUES"]["MIN"]["VALUE"] <= 0)
						continue;
				?>
					<div class="bx_filter_parameters_box active catalog-filter__item">
						<span class="bx_filter_container_modef"></span>
						<div class="bx_filter_parameters_box_title catalog-filter__item-title" onclick="smartFilter.hideFilterProps(this)"><?= $arItem["NAME"] ?></div>
						<div class="bx_filter_block">
							<div class="bx_filter_parameters_box_container">
								...
								<div class="bx_ui_slider_track catalog-filter__track" id="drag_track_<?= $key ?>">
									<?
						...
						<div class="bx_filter_parameters_box_container">
							...
							?>
									...
									<div class="bx_ui_slider_track" id="drag_track_<?= $key ?>">
										...
										?>
										<div class="bx_ui_slider_part p1"><span class="pricespace"><?= $value1 ?></span></div>
									...
									<div class="bx_ui_slider_part p4"><span><?=$value4?></span></div>*/ ?>
										<div class="bx_ui_slider_part p5"><span class="pricespace"><?= $value5 ?></span></div>

										<div class="bx_ui_slider_pricebar_VD catalog-filter__line-vd" style="left: 0;right: 0;" id="colorUnavailableActive_<?= $key ?>"></div>
										<div class="bx_ui_slider_pricebar_VN catalog-filter__line-vn" style="left: 0;right: 0;" id="colorAvailableInactive_<?= $key ?>"></div>
										<div class="bx_ui_slider_pricebar_V catalog-filter__line-v" style="left: 0;right: 0;" id="colorAvailableActive_<?= $key ?>"></div>
										<div class="bx_ui_slider_range" id="drag_tracker_<?= $key ?>" style="left: 0;right: 0;">
											<a class="bx_ui_slider_handle left" style="left:0;" href="javascript:void(0)" id="left_slider_<?= $key ?>"></a>
											<a class="bx_ui_slider_handle right" style="right:0;" href="javascript:void(0)" id="right_slider_<?= $key ?>"></a>
										</div>
								...
								?>
									<? foreach ($arItem["VALUES"] as $val => $ar) : ?>
										<div class="catalog-filter__checkbox">
											<label data-role="label_<?= $ar["CONTROL_ID"] ?>" class="bx_filter_param_label <? echo $ar["DISABLED"] ? 'disabled' : '' ?> catalog-filter__checkbox-label" for="<? echo $ar["CONTROL_ID"] ?>">
												<span class="bx_filter_input_checkbox">
													...
													<span class="bx_filter_param_text checkbox-text" title="<?= $ar["VALUE"]; ?>"><?= $ar["VALUE"]; ?><?
																																																														if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])) :
																																																														?> (<span data-role="count_<?= $ar["CONTROL_ID"] ?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)<?
																																																																																																												endif; ?></span>
												</span>
			...
			<div class="bx_filter_button_box active">
				<div class="bx_filter_block">
					<div class="bx_filter_parameters_box_container">
						<input class="btn-button catalog-filter__button" type="submit" id="set_filter" name="set_filter" value="<?= GetMessage("CT_BCSF_SET_FILTER") ?>" />
						<input class="catalog-filter__button-reset" type="submit" id="del_filter" name="del_filter" value="<?= GetMessage("CT_BCSF_DEL_FILTER") ?>" />
